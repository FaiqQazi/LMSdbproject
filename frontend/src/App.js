...
import TeacherAddCourseAttendance from "./pages/Teacher/TeacherAddCourseAttendence";
    ...
    <>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="/admin/edit/course/:_id" element={<EditCourse />} />


          {/* //* Teacher  */}
          <Route path="/teacher/dashboard/:_id" element={<TeacherDashboard />} />
          <Route path="/teacher/profile" element={<TeacherProfile />} />
          <Route path="/teacher/profile" element={<TeacherProfile />} />
          <Route path="/teacher/courses" element={<TeacherCourses />} />
          <Route path="/teacher/add-attendance" element={<TeacherAddAttendance />} />
          <Route path="teacher/add-attendance/teacher/course-attendance/:_id" element={<TeacherAddCourseAttendance />} />
          <Route path="/teacher/add-marks" element={<AddMarks />} />

          {/* //* Student  */}
          <Route path="/student/dashboard/:_id" element={<StudentDashboard />} />
